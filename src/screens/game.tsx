...
import { tGame, BowlingStats, SeriesStats, Session, SeriesData, Game } from "@/src/values/types";
import { defaultGame, defaultSeriesData, defaultSeriesStats } from "@/src/values/defaults";
...
import useSessionStore from '../zustandStore/sessionStore';
import FrameView, { GameRef } from '../components/scoreboard/FrameView';
import useGameViewStore from '../zustandStore/gameStore';
